...
def scraper_year_check(month, year):
    ...
    while True:
        ...
        li_tags = soup.find_all('li', class_='usa-card card--list pep-card--minimal mobile:grid-col-12')

        data_found = False

        for li in li_tags:
            date_text = li.find('span', class_="text-base-dark padding-right-105").get_text(strip=True) if li.find('span', class_='text-base-dark padding-right-105') else None
            ...
            if date_text:
                ...
                title = li.find('h2', class_="usa-card__heading").get_text(strip=True) if li.find('h2') else None
                category = li.find('li', class_='display-inline-block').get_text(strip=True) if li.find('li', class_='display-inline-block') else None
